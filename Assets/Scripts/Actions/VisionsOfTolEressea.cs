...
public class VisionsOfTolEressea : CharacterAction
{
    ...
    public override void Initialize(Character c, Func<Character, bool> condition = null, Func<Character, bool> effect = null, Func<Character, Task<bool>> asyncEffect = null)
    {
        ...
        async Task<bool> visionsAsync(Character character)
        {
            ...
            MessageDisplayNoUI.ShowMessage(character.hex, character, $"{target.characterName} gains ArcaneInsight (1).", Color.cyan);
            return true;
        }

        base.Initialize(c, condition, effect, visionsAsync);
    }
}
