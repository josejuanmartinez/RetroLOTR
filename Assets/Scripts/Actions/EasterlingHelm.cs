...
public class EasterlingHelm : CharacterAction
{
    ...
    public override void Initialize(Character c, Func<Character, bool> condition = null, Func<Character, bool> effect = null, Func<Character, Task<bool>> asyncEffect = null)
    {
        ...
        async Task<bool> helmAsync(Character character)
        {
            ...
            MessageDisplayNoUI.ShowMessage(character.hex, character, $"{target.characterName} gains Fortified (1 turn) and Haste (1 turn).", Color.cyan);
            return true;
        }
