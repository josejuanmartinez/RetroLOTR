...
public class GondorianTowerShield : CharacterAction
{
    ...
    public override void Initialize(Character c, Func<Character, bool> condition = null, Func<Character, bool> effect = null, Func<Character, Task<bool>> asyncEffect = null)
    {
        ...
        async Task<bool> shieldAsync(Character character)
        {
            ...
            string fearText = clearedFear ? " Fear removed." : string.Empty;
            MessageDisplayNoUI.ShowMessage(character.hex, character, $"{target.characterName} gains Fortified (1 turn).{fearText}", Color.cyan);
            return true;
        }

        base.Initialize(c, condition, effect, shieldAsync);
    }
}
