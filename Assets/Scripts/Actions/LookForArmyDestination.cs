...
public class LookForArmyDestination : CommanderArmyAction
{
    override public void Initialize(Character c, Func<Character, bool> condition = null, Func<Character, bool> effect = null, Func<Character, System.Threading.Tasks.Task<bool>> asyncEffect = null)
    {
        ...
        effect = (c) => {
            ...
            {
                Board.Instance.MoveCharacterOneHex(c, c.hex, army.commander.hex, true); 
            }
            else
            {
                ...
                if (pc != null)
                {
                    Board.Instance.MoveCharacterOneHex(c, c.hex, pc.hex, true);
                }
                else
                {
                    // Move to a random hex in range
                    Board.Instance.MoveCharacterOneHex(c, c.hex, destinations[UnityEngine.Random.Range(0, destinations.Count)], true);
                }
            }
