...
public class UrukVanguard : EventAction
{
    ...
    public override void Initialize(Character c, Func<Character, bool> condition = null, Func<Character, bool> effect = null, Func<Character, Task<bool>> asyncEffect = null)
    {
        ...
        async Task<bool> vanguardAsync(Character character)
        {
            ...
            if (target.hex != null)
            {
                ...
                if (enemyHex != null)
                {
                    ...
                    attackMsg = " Vanguard charges an adjacent enemy!";
                }
            }

            MessageDisplayNoUI.ShowMessage(character.hex, character,
                $"Uruk Vanguard: {target.characterName}'s army gains +2 Heavy Infantry and Haste.{attackMsg}",
                new Color(0.6f, 0.3f, 0.1f));
            return true;
        }

        base.Initialize(c, condition, effect, vanguardAsync);
    }
}
