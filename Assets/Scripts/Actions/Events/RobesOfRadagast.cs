...
public class RobesOfRadagast : CharacterAction
{
    ...
    public override void Initialize(Character c, Func<Character, bool> condition = null, Func<Character, bool> effect = null, Func<Character, Task<bool>> asyncEffect = null)
    {
        ...
        async Task<bool> robesAsync(Character character)
        {
            ...
            if (character.hex.terrainType == TerrainEnum.forest || character.hex.terrainType == TerrainEnum.grasslands)
            {
                character.Heal(10);
                bonusText = " The wild gives back 10 health.";
            }

            MessageDisplayNoUI.ShowMessage(character.hex, character, $"{target.characterName} heals {healAmount} health.{bonusText}", Color.cyan);
            return true;
        }

        base.Initialize(c, condition, effect, robesAsync);
    }
}
