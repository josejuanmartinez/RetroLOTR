...
public class BladeOfGondolin : CharacterAction
{
    ...
    public override void Initialize(Character c, Func<Character, bool> condition = null, Func<Character, bool> effect = null, Func<Character, Task<bool>> asyncEffect = null)
    {
        ...
        async Task<bool> bladeAsync(Character character)
        {
            ...
            MessageDisplayNoUI.ShowMessage(character.hex, character, $"{target.characterName} gains Fortified (1) and Haste (1).", Color.cyan);
            return true;
        }

        base.Initialize(c, condition, effect, bladeAsync);
    }
}
