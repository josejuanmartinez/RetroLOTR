...
public class HaradrimScenticMace : CharacterAction
{
    public override void Initialize(Character c, Func<Character, bool> condition = null, Func<Character, bool> effect = null, Func<Character, Task<bool>> asyncEffect = null)
    {
        ...
        async Task<bool> maceAsync(Character character)
        {
            ...
            MessageDisplayNoUI.ShowMessage(character.hex, character, $"{target.characterName} is battered by the Haradrim Scentic Mace: {wound} damage and Poisoned (2).", Color.magenta);
            return true;
        }

        base.Initialize(c, condition, effect, maceAsync);
    }
}
