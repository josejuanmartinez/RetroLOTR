...
public static class RegionColors
{
    ...
    private static readonly Dictionary<string, Color> Colors = new()
    {
        ...
        { "lithlad",             new Color(0.56f, 0.53f, 0.50f) },
        { "lothlorien",          new Color(0.85f, 0.82f, 0.15f) },
        { "mistymountains",      new Color(0.52f, 0.54f, 0.65f) },
        { "mountainsofmirkwood", new Color(0.32f, 0.42f, 0.36f) },
        { "nearharad",           new Color(0.90f, 0.60f, 0.30f) },
        { "nindalf",             new Color(0.42f, 0.48f, 0.18f) },
        ...
        { "rhudaur",             new Color(0.38f, 0.42f, 0.55f) },
